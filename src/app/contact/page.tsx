                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@weddinginvites.com</p>
                      <p className="text-gray-600">support@weddinginvites.com</p>
                    </div>
                  </div>
                  ...
                  <div className="pt-6">
                    <a
                      ...
                      className="inline-flex items-center bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 transition font-semibold"
                    >
                      <svg
