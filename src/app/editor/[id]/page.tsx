  ...
  return (
    <div className="min-h-screen bg-gray-50 w-full">
      ...
      <div className=" mx-auto px-4 py-8">
        <div className="space-y-6 grid gird-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("heroGroomName", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("heroBrideName", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("weddingVenue", e.target.value)
                  }
                  rows={2}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("whatsappLink", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    {inviteData.images.length}/6 images uploaded
                  </p>
                </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("grandparents", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("groomParents", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("brideParents", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  placeholder="e.g., Mrs. Reena & Mr. Rajiv Kapoor"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("daughterOfText", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("coupleName1", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  placeholder="e.g., Abhishek"
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("coupleName2", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("staffDetails", e.target.value)
                  }
                  rows={2}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("parkingDetails", e.target.value)
                  }
                  rows={2}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              ...
              <div>
                <label className="block text-gray-700 mb-2 font-medium">
                  Venue Location Link (Google Maps)
                </label>
                <input
                  type="url"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("counterDate", e.target.value)
                  }
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
        ...
        <div className="rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-6 mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="space-y-3">
                  <input
                    ...
                    onChange={(e) =>
                      handleEventChange(index, "eventName", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleEventChange(index, "locationLink", e.target.value)
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
          ...
          <div className="bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="border border-gray-300 rounded-lg overflow-hidden bg-gray-50">
              <div>
                ...
                />
                <EventShow events={inviteData.events} />
                <ImageSection
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">
              Changes auto-save every 5 seconds. Click &quot;Save Now&quot; to
              save immediately
            </p>
          </div>
        </div>
